...
CNSI.content = {
  ...
  createIds: function () {
    CNSI.content.ids.forEach(function (key) {
      CNSI.content.id[key] =
        CNSI.content.id.main + "-" + CNSI.utils.kebabize(key);
  ...
  displayNameInfo: function (originHexCode) {
    var nameHexSpan = document
      .getElementById(CNSI.content.id.nameHex)
      .querySelector("span");
    var nameNamesList = document
      .getElementById(CNSI.content.id.nameNames)
      .querySelector("ul");
    var nameExactSpan = document
      .getElementById(CNSI.content.id.nameExact)
      .querySelector("span");
    ...
    if (nameData != null) {
      ...
      if (nameData.names != null) {
        nameData.names.forEach(function (data, i) {
          nameNamesList.innerHTML +=
            "<li>" +
            CNSI.utils.getColorNameDisplay(
              data.name,
              data.source,
              data.number,
            ) +
  ...
  displaySeasonInfo: function (originHexCode) {
    var seasonsHexSpan = document
      .getElementById(CNSI.content.id.seasonsHex)
      .querySelector("span");
    var seasonsGoodList = document
      .getElementById(CNSI.content.id.seasonsGood)
      .querySelector("ul");
    var seasonsBadList = document
      .getElementById(CNSI.content.id.seasonsBad)
      .querySelector("ul");
    var seasonsExactSpan = document
      .getElementById(CNSI.content.id.seasonsExact)
      .querySelector("span");
    ...
    if (seasonData != null) {
      ...
      if (seasonData.good != null) {
        seasonData.good.forEach(function (data, i) {
          seasonsGoodList.innerHTML +=
            "<li>" +
            CNSI.utils.getColorSeasonDisplay(
              data.season,
              data.seasonType,
              data.colorType,
            ) +
  ...
  setImageData: function () {
    ...
    var data = canvasContext.getImageData(
    ...
    rgbaKeys.forEach(function (component, componentIndex) {
      ...
      var span = document
        .getElementById(CNSI.content.id["originRgba" + component.toUpperCase()])
        .querySelector("span");
    ...
    var hexSpan = document
      .getElementById(CNSI.content.id.originHex)
      .querySelector("span");
    ...
    hsvKeys.forEach(function (component, componentIndex) {
      ...
      var span = document
        .getElementById(CNSI.content.id["originHsv" + component.toUpperCase()])
        .querySelector("span");
      if (component == "h") {
        span.innerHTML = componentValue + "°";
      } else {
