...
const CnsiData = {
		...
		Object.keys(CnsiData.colors).forEach((currentHex, i) => {
			...
			if (CnsiData.colors[currentHex][dataType]) {
				...
				if (CnsiData.colors[currentHex].rgb) {
					rgbDiff = Math.sqrt(
						Math.pow(
							originR - CnsiData.colors[currentHex].rgb!.r,
							2
						) +
							Math.pow(
								originG - CnsiData.colors[currentHex].rgb!.g,
								2
							) +
							Math.pow(
								originB - CnsiData.colors[currentHex].rgb!.b,
								2
							)
					);
				}
				if (CnsiData.colors[currentHex].hsl) {
					hslDiff = Math.sqrt(
						Math.pow(
							originH - CnsiData.colors[currentHex].hsl!.h,
							2
						) +
							Math.pow(
								originS - CnsiData.colors[currentHex].hsl!.s,
								2
							) +
							Math.pow(
								originL - CnsiData.colors[currentHex].hsl!.l,
								2
							)
					);
				}
	...
	colors: {
		...
		"000471": {
			seasons: {
				good: [
					{ season: "winter", seasonType: "bright", colorType: "ca" },
				],
			},
		},
		"001baa": {
		...
		"003d63": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "true", colorType: "ca" },
				],
			},
		},
		"003e23": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "bright", colorType: "ca" },
				],
			},
		},
		"0042a8": {
		...
		"005d4c": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Opal Green", source: "RAL", number: "6036" },
				],
			},
		},
		"005950": {
		...
		"008754": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Green", source: "RAL", number: "6024" },
				],
			},
		},
		"008b8b": {
		...
		"009473": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Emerald", source: "Pantone", number: "17-5641" },
				],
			},
		},
		"0095b7": {
		...
		"00f700": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Luminous Green", source: "RAL", number: "6038" },
				],
			},
		},
		"00fa9a": {
		...
		"012477": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "bright", colorType: "fn" },
				],
			},
		},
		"01786f": {
		...
		"026a52": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Turquoise Green", source: "RAL", number: "6016" },
				],
			},
		},
		"0285ea": {
		...
		"0d7eba": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "dark", colorType: "ca" },
				],
			},
		},
		"0e4243": {
		...
		"0e518d": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Blue", source: "RAL", number: "5017" },
				],
			},
		},
		"0e547f": {
		...
		"0f8558": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Green", source: "RAL", number: "6032" },
				],
			},
		},
		"0f0f52": {
		...
		"102c54": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Night Blue", source: "RAL", number: "5026" },
				],
			},
		},
		"10759a": {
		...
		"125d77": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "true", colorType: "ca" },
				],
			},
		},
		133733: {
		...
		"13447c": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Gentian Blue", source: "RAL", number: "5010" },
				],
			},
		},
		"134c4f": {
		...
		"1c1c1c": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Graphite Black", source: "RAL", number: "9011" },
				],
			},
		},
		"1c2c59": {
		...
		"1e1e1e": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Black", source: "RAL", number: "9017" },
				],
			},
		},
		"1e4657": {
		...
		"1f2852": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "dark", colorType: "fn" },
				],
			},
		},
		"1f4764": {
		...
		"21888f": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Turquoise Blue", source: "RAL", number: "5018" },
				],
			},
		},
		218975: {
		...
		"234a6c": {
			seasons: {
				good: [
					{ season: "summer", seasonType: "true", colorType: "fn" },
				],
			},
		},
		"234c8c": {
		...
		"254c70": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "true", colorType: "fn" },
				],
			},
		},
		"256d96": {
		...
		"25885e": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "light", colorType: "ca" },
				],
			},
		},
		"25898b": {
		...
		282828: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Black", source: "RAL", number: "9004" },
				],
			},
		},
		283424: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Bottle Green", source: "RAL", number: "6007" },
				],
			},
		},
		"2863b1": {
		...
		"28713e": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Emerald Green", source: "RAL", number: "6001" },
				],
			},
		},
		"2874b2": {
		...
		"29ab87": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Jungle Green, Koala Tree", source: "Crayola" },
				],
			},
		},
		"2a2a32": {
		...
		"2a3756": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Saphire Blue", source: "RAL", number: "5003" },
				],
			},
		},
		"2a4077": {
		...
		"2b2c7c": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Ultramarine Blue", source: "RAL", number: "5002" },
				],
			},
		},
		"2b3372": {
		...
		"2e5d6d": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "soft", colorType: "ca" },
				],
			},
		},
		"2e8082": {
		...
		"32222f": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "true", colorType: "fn" },
				],
			},
		},
		323468: {
		...
		327662: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Patina Green", source: "RAL", number: "6000" },
				],
			},
		},
		...
		"335f60": {
			seasons: {
				good: [
					{ season: "summer", seasonType: "soft", colorType: "ca" },
				],
			},
		},
		342634: {
		...
		354733: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Chrome Green", source: "RAL", number: "6020" },
				],
			},
		},
		"35757e": {
		...
		"373f43": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Anthracite Grey", source: "RAL", number: "7016" },
				],
			},
		},
		374447: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Granite Grey", source: "RAL", number: "7026" },
				],
			},
		},
		375196: {
		...
		"3f3e40": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "soft", colorType: "fn" },
				],
			},
		},
		"3f464e": {
		...
		"41678d": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Brilliant Blue", source: "RAL", number: "5007" },
				],
			},
		},
		"4169e1": {
		...
		"44322d": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Chocolate Brown", source: "RAL", number: "8017" },
				],
			},
		},
		444337: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Yellow Olive", source: "RAL", number: "6014" },
				],
			},
		},
		"444d56": {
		...
		"453b3a": {
			seasons: {
				good: [
					{ season: "summer", seasonType: "soft", colorType: "fn" },
				],
			},
		},
		"454d60": {
		...
		"45b5aa": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Turquoise", source: "Pantone", number: "15-5519" },
				],
			},
		},
		"45cbdc": {
		...
		"474a50": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Graphite Grey", source: "RAL", number: "7024" },
				],
			},
		},
		"474b43": {
		...
		"478a84": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Mint Turquoise", source: "RAL", number: "6033" },
				],
			},
		},
		"47abcc": {
		...
		"48a43f": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Yellow Green", source: "RAL", number: "6018" },
				],
			},
		},
		"48b6d5": {
		...
		"4a203b": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Purple Violet", source: "RAL", number: "4007" },
				],
			},
		},
		"4a3b34": {
		...
		"4a4d46": {
			seasons: {
				good: [
					{ season: "spring", seasonType: "light", colorType: "fn" },
				],
			},
		},
		"4a646c": {
		...
		"4c2f26": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Mahogany Brown", source: "RAL", number: "8016" },
				],
			},
		},
		"4c88dd": {
		...
		"4e6b88": {
			seasons: {
				good: [
					{ season: "summer", seasonType: "light", colorType: "fn" },
				],
			},
		},
		"4d445e": {
		...
		"4d668e": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Distant Blue", source: "RAL", number: "5023" },
				],
			},
		},
		"4d8c57": {
		...
		"4e5451": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Grey B", source: "RAL", number: "7043" },
				],
			},
		},
		"4f69c6": {
		...
		"575d57": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Tarpaulin Grey", source: "RAL", number: "7010" },
				],
			},
		},
		"57a6fc": {
		...
		"5a5b9f": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Blue Iris", source: "Pantone", number: "18-3943" },
				],
			},
		},
		"5a64a8": {
		...
		"633a34": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Chestnut Brown", source: "RAL", number: "8015" },
				],
			},
		},
		"634d1f": {
		...
		"68825b": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Reseda Green", source: "RAL", number: "6011" },
				],
			},
		},
		"68b4de": {
		...
		691639: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Claret Violet", source: "RAL", number: "4004" },
				],
			},
		},
		694721: {
		...
		"6b6880": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Blackberry", source: "RAL", number: "4012" },
				],
			},
		},
		"6b695f": {
		...
		711521: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Ruby Red", source: "RAL", number: "3032" },
				],
			},
		},
		"71bbbb": {
		...
		"763c28": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Copper", source: "RAL", number: "8029" },
				],
			},
		},
		765041: {
		...
		"76d7ea": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Sky Blue, Fresh Air (magic)", source: "Crayola" },
				],
			},
		},
		772642: {
		...
		"7a7675": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "dark", colorType: "m" },
				],
			},
		},
		"7a7b6d": {
		...
		"7b5141": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Brown", source: "RAL", number: "8002" },
				],
			},
		},
		"7b68ee": {
		...
		"7bc4c4": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Aqua Sky", source: "Pantone", number: "14-4811" },
				],
			},
		},
		"7c74a9": {
		...
		"7e8b92": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Squirrel Grey", source: "RAL", number: "7000" },
				],
			},
		},
		"7ed4e6": {
		...
		"7fb0b2": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pastel Turquoise", source: "RAL", number: "6034" },
				],
			},
		},
		"7fff00": {
		...
		818479: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Concrete Grey", source: "RAL", number: "7023" },
				],
			},
		},
		818979: {
		...
		828282: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Dark Grey", source: "RAL", number: "9023" },
				],
			},
		},
		"82898e": {
		...
		"8773a1": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Violet", source: "RAL", number: "4011" },
				],
			},
		},
		"877f42": {
		...
		888175: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Mouse Grey", source: "RAL", number: "7048" },
				],
			},
		},
		"8896d3": {
		...
		"88b04b": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Greenery", source: "Pantone", number: "15-0343" },
				],
			},
		},
		"88b3a1": {
		...
		"8f4e35": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Copper Brown", source: "RAL", number: "8004" },
				],
			},
		},
		"8f674f": {
		...
		"8f8f8f": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Grey Aluminum", source: "RAL", number: "9007" },
				],
			},
		},
		"8f9695": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Grey A", source: "RAL", number: "7042" },
				],
			},
		},
		"8f999f": {
		...
		904684: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Violet", source: "RAL", number: "4008" },
				],
			},
		},
		907969: {
		...
		"92a8d1": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Serenity", source: "Pantone", number: "15-3913" },
				],
			},
		},
		"92c4ca": {
		...
		954527: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Orange", source: "RAL", number: "2013" },
				],
			},
		},
		955251: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Marsala", source: "Pantone", number: "18-1438" },
				],
			},
		},
		"95e0e8": {
		...
		992572: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Purple", source: "RAL", number: "4006" },
				],
			},
		},
		"9932cc": {
		...
		"9a7048": {
			seasons: {
				good: [
					{ season: "autumn", seasonType: "true", colorType: "m" },
				],
			},
		},
		"9a8043": {
		...
		"9a9464": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Olive Yellow", source: "RAL", number: "1020" },
				],
			},
		},
		"9a9697": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Platinum Grey", source: "RAL", number: "7036" },
				],
			},
		},
		"9a9aa6": {
		...
		"9bb7d4": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Cerulean", source: "Pantone", number: "15-4020" },
				],
			},
		},
		"9c2542": {
		...
		"9c9c9c": {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pearl Light Grey", source: "RAL", number: "9022" },
				],
			},
		},
		"9caed7": {
		...
		a38995: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pastel Violet", source: "RAL", number: "4009" },
				],
			},
		},
		a38c15: {
		...
		a5a5a5: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "White Aluminum", source: "RAL", number: "9006" },
				],
			},
		},
		a63a79: {
		...
		a65e2f: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Orange Brown", source: "RAL", number: "8023" },
				],
			},
		},
		a6a6a6: {
		...
		b42041: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Raspberry Red", source: "RAL", number: "3027" },
				],
			},
		},
		b4264c: {
		...
		b7d9b1: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pastel Green", source: "RAL", number: "6019" },
				],
			},
		},
		b7b6bf: {
		...
		b89c50: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Ochre Yellow", source: "RAL", number: "1024" },
				],
			},
		},
		b8b290: {
		...
		bf1932: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "True Red", source: "Pantone", number: "19-1664" },
				],
			},
		},
		bf2261: {
		...
		c89f04: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Honey Yellow", source: "RAL", number: "1005" },
				],
			},
		},
		c8a788: {
		...
		d14152: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Strawberry Red", source: "RAL", number: "3018" },
				],
			},
		},
		d15b8f: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Heather Violet", source: "RAL", number: "4003" },
				],
			},
		},
		d1942e: {
		...
		d4652f: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Orange", source: "RAL", number: "2010" },
				],
			},
		},
		d47479: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Antique Pink", source: "RAL", number: "3014" },
				],
			},
		},
		d4cd8b: {
		...
		d6aedd: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Purple Mountains' Majesty", source: "Crayola" },
				],
			},
		},
		d6caca: {
		...
		d7d7d7: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Papyrus White", source: "RAL", number: "9018" },
				],
			},
		},
		d8608b: {
		...
		d9c022: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Lemon Yellow", source: "RAL", number: "1012" },
				],
			},
		},
		d9d4da: {
		...
		db6a50: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Salmon Orange", source: "RAL", number: "2012" },
				],
			},
		},
		db7093: {
		...
		dd7907: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Yellow Orange", source: "RAL", number: "2000" },
				],
			},
		},
		dd7e89: {
		...
		ddb20f: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Broom Yellow", source: "RAL", number: "1032" },
				],
			},
		},
		ddd5ae: {
		...
		e15501: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Orange", source: "RAL", number: "2009" },
				],
			},
		},
		e16069: {
		...
		e1a100: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Maize Yellow", source: "RAL", number: "1006" },
				],
			},
		},
		e1a6ad: {
		...
		e2583e: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Tigerlily", source: "Pantone", number: "17-1456" },
				],
			},
		},
		e25e77: {
		...
		e2b007: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Golden Yellow", source: "RAL", number: "1004" },
				],
			},
		},
		e2c791: {
		...
		e79c00: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Daffodil Yellow", source: "RAL", number: "1007" },
				],
			},
		},
		e7ebda: {
		...
		e97451: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Burnt Sienna, Baseball Mitt", source: "Crayola" },
				],
			},
		},
		e9967a: {
		...
		e9e5ce: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Oyster White", source: "RAL", number: "1013" },
				],
			},
			seasons: {
				good: [
		...
		eaf044: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Sulfur Yellow", source: "RAL", number: "1016" },
				],
			},
		},
		ebb0d7: {
		...
		edab56: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pastel Yellow", source: "RAL", number: "1034" },
				],
			},
		},
		edc9af: {
		...
		f0c05a: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Mimosa", source: "Pantone", number: "14-0848" },
				],
			},
		},
		f0ca00: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic Yellow", source: "RAL", number: "1023" },
				],
			},
		},
		f0e07e: {
		...
		f4b752: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Saffron Yellow", source: "RAL", number: "1017" },
				],
			},
		},
		f4b7c6: {
		...
		f4f4f4: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal White", source: "RAL", number: "9003" },
				],
			},
		},
		f578aa: {
		...
		f5ff00: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Luminous Yellow", source: "RAL", number: "1026" },
				],
			},
		},
		f5fffa: {
		...
		f6f6f6: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Traffic White", source: "RAL", number: "9016" },
				],
			},
		},
		f70000: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Luminous Red", source: "RAL", number: "3024" },
				],
			},
		},
		f7468a: {
		...
		f7ba0b: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Signal Yellow", source: "RAL", number: "1003" },
				],
			},
		},
		f7bd57: {
		...
		fa842b: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Pastel Orange", source: "RAL", number: "2003" },
				],
			},
		},
		fa8cbe: {
		...
		faab21: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Dahlia Yellow", source: "RAL", number: "1033" },
				],
			},
		},
		faadc3: {
		...
		fc80a5: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Tickle Me Pink, Bubble Bath", source: "Crayola" },
				],
			},
		},
		fcd667: {
			names: {
				...
				names: [
					{
						name: "Goldenrod, Sharpening Pencils",
						source: "Crayola",
					},
				],
			},
		...
		ff00cc: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Hot Magenta, Purple Pizzazz", source: "Crayola" },
				],
			},
		},
		ff00ff: {
		...
		ff2300: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Luminous Orange", source: "RAL", number: "2005" },
				],
			},
		},
		ff3399: {
		...
		ff8833: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Orange, Grandma's Perfume", source: "Crayola" },
				],
			},
		},
		ff8866: {
		...
		ffab00: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Melon Yellow", source: "RAL", number: "1028" },
				],
			},
		},
		ffae42: {
		...
		ffff66: {
			names: {
				//need this as an object since we need to append additional properties to this info later
				names: [
					{ name: "Laser Lemon, Unmellow Yellow", source: "Crayola" },
				],
			},
		},
		ffff99: {
