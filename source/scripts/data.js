...
CNSI.data = {
	...
	findClosestHex: function(originHexCode, dataType) {
		...
		var originR = rgb.r, originG = rgb.g, originB = rgb.b;

		var hsl = CNSI.utils.hexToHSL(originHexCode);
		var originH = hsl.h, originS = hsl.s, originL = hsl.l;

		var rgbDiff = 0, hslDiff = 0, currentDiff = 0;
		var closestHex = null, smallestDiff = -1;
	...
	getColorData: function(originHexCode, dataType) {
		...
		if (CNSI.data.colors[hex] != null && CNSI.data.colors[hex][dataType] != null) {
			...
			if (CNSI.data.colors[closestHex] != null && CNSI.data.colors[closestHex][dataType] != null) {
	...
	colors: {
		"000000": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Black", "source": "X11" },
		...
		"000080": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Navy Blue", "source": "X11" },
				 			{ "name": "Navy", "source": "W3C" }]
			}
		},
		"00008b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Blue", "source": "X11" },
				 			{ "name": "Dark Blue", "source": "W3C" }]
			}
		},
		"0000cd": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Blue", "source": "X11" },
				 			{ "name": "Medium Blue", "source": "W3C" }]
			}
		},
		"0000ff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Blue", "source": "X11" },
		...
		"006400": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Green", "source": "X11" },
		...
		"008000": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Web Green", "source": "X11" },
		...
		"008b8b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Cyan", "source": "X11" },
		...
		"00bfff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Deep Sky Blue", "source": "X11" },
		...
		"00ced1": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Turquoise", "source": "X11" },
		...
		"00fa9a": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Spring Green", "source": "X11" },
				 			{ "name": "Medium Spring Green", "source": "W3C" }]
			}
		},
		"00ff00": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Green", "source": "X11" },
				 			{ "name": "Lime", "source": "W3C" }]
			}
		},
		"00ff7f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Spring Green", "source": "X11" },
				 			{ "name": "Spring Green", "source": "W3C" }]
			}
		},
		"00ffff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Cyan", "source": "X11" },
		...
		"191970": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Midnight Blue", "source": "X11" },
		...
		"1e90ff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dodger Blue", "source": "X11" },
		...
		"20b2aa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Sea Green", "source": "X11" },
		...
		"228b22": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Forest Green", "source": "X11" },
		...
		"2e8b57": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Sea Green", "source": "X11" },
		...
		"2f4f4f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Slate Gray", "source": "X11" },
		...
		"32cd32": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Lime Green", "source": "X11" },
		...
		"3cb371": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Sea Green", "source": "X11" },
		...
		"40e0d0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Turquoise", "source": "X11" },
		...
		"4169e1": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Royal Blue", "source": "X11" },
		...
		"4682b4": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Steel Blue", "source": "X11" },
		...
		"483d8b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Slate Blue", "source": "X11" },
		...
		"48d1cc": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Turquoise", "source": "X11" },
		...
		"53b0ae": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Blue Turquoise", "source": "Pantone", "number": "15-5217" }]
			}
		},
		"53c665": {
			"seasons": {
		...
		"555548": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Brown Grey, NATO Olive, Stone-Grey Olive", "source": "RAL", "number": "7013" }]
			}
		},
		"555d61": {
			"names": { //need this as an object since we need to append additional properties to this info later
		...
		"556b2f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Olive Green", "source": "X11" },
		...
		"5f9ea0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Cadet Blue", "source": "X11" },
		...
		"6495ed": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Cornflower Blue", "source": "X11" },
		...
		"663399": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Rebecca Purple", "source": "X11" },
		...
		"66cdaa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Aquamarine", "source": "X11" },
		...
		"696969": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dim Gray", "source": "X11" },
		...
		"6a5acd": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Slate Blue", "source": "X11" },
		...
		"6b8e23": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Olive Drab", "source": "X11" },
		...
		"708090": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Slate Gray", "source": "X11" },
		...
		"778899": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Slate Gray", "source": "X11" },
		...
		"7b68ee": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Slate Blue", "source": "X11" },
		...
		"7cfc00": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Lawn Green", "source": "X11" },
		...
		"7fff00": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Chartreuse", "source": "X11" },
				 			{ "name": "Chartreuse", "source": "W3C" }]
			}
		},
		"7fffd4": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Aquamarine", "source": "X11" },
				 			{ "name": "Aquamarine", "source": "W3C" }]
			}
		},
		"800000": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Web Maroon", "source": "X11" },
				 			{ "name": "Maroon", "source": "W3C" }]
			}
		},
		"800080": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Web Purple", "source": "X11" },
		...
		"808000": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Olive", "source": "X11" },
				 			{ "name": "Olive", "source": "W3C" }]
			}
		},
		"808080": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Web Gray", "source": "X11" },
		...
		"87ceeb": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Sky Blue", "source": "X11" },
				 			{ "name": "Sky Blue", "source": "W3C" }]
			}
		},
		"87cefa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Sky Blue", "source": "X11" },
		...
		"8a2be2": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Blue Violet", "source": "X11" },
		...
		"8b0000": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Red", "source": "X11" },
				 			{ "name": "Dark Red", "source": "W3C" }]
			}
		},
		"8b008b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Magenta", "source": "X11" },
				 			{ "name": "Dark Magenta", "source": "W3C" }]
			}
		},
		"8b4513": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Saddle Brown", "source": "X11" },
		...
		"8fbc8f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Sea Green", "source": "X11" },
		...
		"90ee90": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Green", "source": "X11" },
		...
		"9370db": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Purple", "source": "X11" },
		...
		"9400d3": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Violet", "source": "X11" },
		...
		"98fb98": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Pale Green", "source": "X11" },
		...
		"9932cc": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Orchid", "source": "X11" },
		...
		"9acd32": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Yellow Green", "source": "X11" },
		...
		"a9a9a9": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Gray", "source": "X11" },
		...
		"add8e6": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Blue", "source": "X11" },
		...
		"adff2f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Green Yellow", "source": "X11" },
		...
		"afeeee": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Pale Turquoise", "source": "X11" },
		...
		"b0c4de": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Steel Blue", "source": "X11" },
				 			{ "name": "Light Steel Blue", "source": "W3C" }]
			}
		},
		"b0e0e6": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Powder Blue", "source": "X11" },
				 			{ "name": "Powder Blue", "source": "W3C" }]
			}
		},
		"b163a3": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Radiant Orchid", "source": "Pantone", "number": "18-3224" }]
			}
		},
		"b22222": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Firebrick", "source": "X11" },
		...
		"b7b6bf": {
			"seasons": {
				"good": [{ "season": "spring", "seasonType": "bright", "colorType": "m" },
		...
		"b8860b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Goldenrod", "source": "X11" },
		...
		"ba55d3": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Orchid", "source": "X11" },
		...
		"bc8f8f": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Rosy Brown", "source": "X11" },
		...
		"bdb76b": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Khaki", "source": "X11" },
		...
		"c71585": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Medium Violet Red", "source": "X11" },
		...
		"cd5c5c": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Indian Red", "source": "X11" },
		...
		"d2691e": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Chocolate", "source": "X11" },
		...
		"d3d3d3": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Gray", "source": "X11" },
		...
		"daa520": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Goldenrod", "source": "X11" },
		...
		"db7093": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Pale Violet Red", "source": "X11" },
		...
		"dcdcdc": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Gainsboro", "source": "X11" },
		...
		"dd4124": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Tangerine Tango", "source": "Pantone", "number": "17-1463" }]
			}
		},
		"dd4760": {
			"seasons": {
		...
		"deb887": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Burlywood", "source": "X11" },
		...
		"e0ffff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Cyan", "source": "X11" },
		...
		"e6e6fa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Lavender", "source": "X11" },
		...
		"e9967a": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Salmon", "source": "X11" },
		...
		"eee8aa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Pale Goldenrod", "source": "X11" },
		...
		"f08080": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Coral", "source": "X11" },
		...
		"f0f8ff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Alice Blue", "source": "X11" },
				 			{ "name": "Alice Blue", "source": "W3C" }]
			}
		},
		"f0fff0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Honeydew", "source": "X11" },
				 			{ "name": "Honeydew", "source": "W3C" }]
			}
		},
		"f0ffff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Azure", "source": "X11" },
		...
		"f4a460": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Sandy Brown", "source": "X11" },
		...
		"f5f5dc": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Beige", "source": "X11" },
				 			{ "name": "Beige", "source": "W3C" }]
			}
		},
		"f5f5f5": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "White Smoke", "source": "X11" },
		...
		"f5fffa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Mint Cream", "source": "X11" },
		...
		"f8f8ff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Ghost White", "source": "X11" },
		...
		"faebd7": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Antique White", "source": "X11" },
		...
		"fafad2": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Goldenrod", "source": "X11" },
		...
		"fdf5e6": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Old Lace", "source": "X11" },
		...
		"ff00ff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Magenta", "source": "X11" },
				 			{ "name": "Fuchsia", "source": "W3C" }]
			}
		},
		"ff1493": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Deep Pink", "source": "X11" },
		...
		"ff4500": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Orange Red", "source": "X11" },
		...
		"ff69b4": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Hot Pink", "source": "X11" },
		...
		"ff8c00": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Dark Orange", "source": "X11" },
		...
		"ffa07a": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Salmon", "source": "X11" },
				 			{ "name": "Light Salmon", "source": "W3C" }]
			}
		},
		"ffa421": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Luminous Bright Orange", "source": "RAL", "number": "2007" }]
			}
		},
		"ffa500": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Orange", "source": "X11" },
		...
		"ffb6c1": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Pink", "source": "X11" },
		...
		"ffd700": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Gold", "source": "X11" },
				 			{ "name": "Gold", "source": "W3C" }]
			}
		},
		"ffdab9": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Peach Puff", "source": "X11" },
		...
		"ffdead": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Navajo White", "source": "X11" },
		...
		"ffe4b5": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Moccasin", "source": "X11" },
				 			{ "name": "Moccasin", "source": "W3C" }]
			}
		},
		"ffe4c4": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Bisque", "source": "X11" },
		...
		"ffe4e1": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Misty Rose", "source": "X11" },
		...
		"ffebcd": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Blanched Almond", "source": "X11" },
				 			{ "name": "Blanched Almond", "source": "W3C" }]
			}
		},
		"ffefd5": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Papaya Whip", "source": "X11" },
				 			{ "name": "Papaya Whip", "source": "W3C" }]
			}
		},
		"fff0f5": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Lavender Blush", "source": "X11" },
				 			{ "name": "Lavender Blush", "source": "W3C" }]
			}
		},
		"fff5ee": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Seashell", "source": "X11" },
		...
		"fff8dc": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Cornsilk", "source": "X11" },
				 			{ "name": "Cornsilk", "source": "W3C" }]
			}
		},
		"fffacd": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Lemon Chiffon", "source": "X11" },
				 			{ "name": "Lemon Chiffon", "source": "W3C" }]
			}
		},
		"fffaf0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Floral White", "source": "X11" },
				 			{ "name": "Floral White", "source": "W3C" }]
			}
		},
		"fffafa": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Snow", "source": "X11" },
				 			{ "name": "Snow", "source": "W3C" }]
			}
		},
		"ffff00": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Yellow", "source": "X11" },
		...
		"ffffe0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Light Yellow", "source": "X11" },
				 			{ "name": "Light Yellow", "source": "W3C" }]
			}
		},
		"fffff0": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "Ivory", "source": "X11" },
				 			{ "name": "Ivory", "source": "W3C" }]
			}
		},
		"ffffff": {
			"names": { //need this as an object since we need to append additional properties to this info later
				"names": [ { "name": "White", "source": "X11" },
