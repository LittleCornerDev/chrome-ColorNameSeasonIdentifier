...
globalThis.chrome = {
	...
	storage: {
		local: {
			get: async () => { console.log('chrome.storage.local.get'); },
			set: async () => { console.log('chrome.storage.local.set'); },
		}
	},
	tabs: {
		onActivated: {
		...
		executeScript: async () => { console.log('chrome.tabs.executeScript'); },
		get: async () => { console.log('chrome.tabs.get'); },
		query: async () => { console.log('chrome.tabs.query'); },
